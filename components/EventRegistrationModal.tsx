...
export default function EventRegistrationModal({ event, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative w-full sm:max-w-lg bg-white dark:bg-gray-900 rounded-t-3xl sm:rounded-3xl shadow-2xl animate-fadeInUp max-h-[90vh] overflow-y-auto">
        {/* Close */}
        <button onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors z-10">
          <X className="w-5 h-5" />
        </button>
        ...
        {submitted ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-xl font-extrabold text-gray-900 dark:text-white mb-2">Fast geschafft!</h3>
          ...
          <>
            ...
            <div className="p-6 border-b border-gray-100 dark:border-gray-800">
              ...
              <h2 className="text-xl font-extrabold text-gray-900 dark:text-white mb-3">{event.title}</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input required value={name} onChange={(e) => setName(e.target.value)}
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" />
              </div>
